    ...
    if (typeof window.define === 'function') {
        ...
        layui.define('jquery',function (exports) {
            ...
            var init=function(elem){
                ...
                return new wangEditor(elem);
            }
            exports('wangeditor',init);
        });
...
(function (window, $) {
    //编辑器 focus
    $('body').on('focus','.wangEditor-txt',function(){
        $(this).parent('.wangEditor-container').attr('focus','');
    });
    $('body').on('blur','.wangEditor-txt',function(){
        $(this).parents('.wangEditor-container').removeAttr('focus');
    });
})(window, $);
// editor 绑定事件
_e(function (E, $) {
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        menu.clickEvent = function (e) {
            ...
            //设置layui-body 层级比header高一级
            $('.layui-layout-admin .layui-body').css({zIndex:1000});
        };
        ...
        menu.clickEventSelected = function (e) {
            ...
            //还原layui-body 层级
            $('.layui-layout-admin .layui-body').css('z-index','');
        };
